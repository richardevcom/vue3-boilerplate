<template>
  <div class="flex">
    <aside
      class="fixed top-0 left-0 z-40 w-64 transition-transform -translate-x-full sm:translate-x-0 h-screen border-r border-gray-200"
      aria-label="Sidenav"
    >
      <div class="overflow-y-auto py-5 px-3 h-full">
        ...
        >
          <li class="pl-2 font-bold">Workspace</li>
          <li>
            <a
              href="#"
            ...
            >
              ...
              <span class="ml-3">House Managerment</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span class="ml-3">Portforlio</span>
            </a>
          </li>
        </ul>
      </div>
